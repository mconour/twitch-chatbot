! function () {
    ...
    2: [function (e, t, s) {
        ...
        var n = e("request"),
            ...
            o = function (e, t) {
                ...
                else if (i.isExtension() || i.isReactNative()) {
                    e = i.merge({
                        url: s,
                        method: "GET",
                        headers: {}
    ...
    3: [function (e, t, s) {
        (function (s) {
            ...
            for (var m in i) h.prototype[m] = i[m];
            h.prototype.handleMessage = function (e) {
                ...
                if (!u.isNull(e)) {
                    ...
                    if (u.isNull(e.prefix)) switch (e.command) {
                        ...
                        case "PONG":
                            var h = new Date;
                            this.currentLatency = (h.getTime() - this.latency.getTime()) / 1e3, this.emits(["pong", "_promisePing"], [
                                [this.currentLatency]
                        ...
                        case "NOTICE":
                            ...
                            switch (i) {
                                case "subs_on":
                                    this.log.info("[" + s + "] This room is now in subscribers-only mode."), this.emits(["subscriber", "subscribers", "_promiseSubscribers"], [b, b, g]);
                                    break;
                                case "subs_off":
                                    ...
                                    break;
                                case "emote_only_on":
                                    this.log.info("[" + s + "] This room is now in emote-only mode."), this.emits(["emoteonly", "_promiseEmoteonly"], [b, g]);
                                    break;
                                case "emote_only_off":
                                ...
                                case "followers_off":
                                    break;
                                case "r9k_on":
                                    this.log.info("[" + s + "] This room is now in r9k mode."), this.emits(["r9kmode", "r9kbeta", "_promiseR9kbeta"], [b, b, g]);
                                    break;
                                case "r9k_off":
                        ...
                        case "HOSTTARGET":
                            var j = n.split(" "),
                                U = ~~j[1] || 0;
                            "-" === j[0] ? (this.log.info("[" + s + "] Exited host mode."), this.emits(["unhost", "_promiseUnhost"], [
                                [s, U],
                                [null]
                            ])) : (this.log.info("[" + s + "] Now hosting " + j[0] + " for " + U + " viewer(s)."), this.emit("hosting", s, j[0], U));
                            break;
                        case "CLEARCHAT":
                                ...
                                if (e.tags.hasOwnProperty("slow"))
                                    ...
                                    if ("-1" === e.tags["followers-only"]) {
                                        ...
                                        var q = ~~e.tags["followers-only"],
                                            G = [s, !0, q];
                                        this.log.info("[" + s + "] This room is now in follower-only mode."), this.emits(["followersonly", "followersmode", "_promiseFollowers"], [G, G, [null]])
                                    }
                            }
                            break;
                        case "SERVERCHANGE":
                        ...
                        case "PART":
                            ...
                            if (this.username === V) {
                                ...
                                var z = this.channels.indexOf(s); - 1 !== z && this.channels.splice(z, 1);
                                var z = this.opts.channels.indexOf(s); - 1 !== z && this.opts.channels.splice(z, 1), this.log.info("Left " + s), this.emit("_promisePart", null)
                            }
                        ...
                        case "PRIVMSG":
                            if (e.tags.username = e.prefix.split("!")[0], "jtv" === e.tags.username) {
                                ...
                                X ? (e.tags["message-type"] = "action", this.log.info("[" + s + "] *<" + e.tags.username + ">: " + X[1]), this.emits(["action", "message"], [
                                    [s, e.tags, X[1], !1]
                ...
                return new Promise(function (o, r) {
                    ...
                    if ("number" == typeof e && u.promiseDelay(e).then(function () {
                        ...
                        }), u.isNull(t)) i.log.info("Executing command: " + s), i.ws.send(s);
                    else {
                        var a = u.channel(t);
                ...
                return new Promise(function (o, r) {
                    ...
                    var m = u.merge(i.userstate[c], a.emotes({
                        ...
                        f = u.actionMessage(s);
                    f ? (m["message-type"] = "action", i.log.info("[" + c + "] *<" + i.getUsername() + ">: " + f[1]), i.emits(["action", "message"], [
                        [c, m, f[1], !0]
                    ])) : (m["message-type"] = "chat", i.log.info("[" + c + "] <" + i.getUsername() + ">: " + s), i.emits(["chat", "message"], [
                        [c, m, s, !0]
                    ])), n(o, r)
                })
    ...
    7: [function (e, t, s) {
        ...
        function n(e, t) {
            ...
            if (e[t] = {}, a)
                for (var c = r.split(s), l = 0; l < c.length; l++) {
                    var u = c[l].split(n),
                        h = u[1];
        ...
        t.exports = {
            ...
            emoteRegex: function (e, t, s, n) {
                o.lastIndex = 0;
                for (var r, a = new RegExp("(\\b|^|s)" + i.unescapeHtml(t) + "(\\b|$|s)"); null !== (r = o.exec(e));) a.test(r[0]) && (n[s] = n[s] || [], n[s].push([r.index, o.lastIndex - 1]))
            },
            emoteString: function (e, t, s, n) {
                o.lastIndex = 0;
                for (var r; null !== (r = o.exec(e));) r[0] === i.unescapeHtml(t) && (n[s] = n[s] || [], n[s].push([r.index, o.lastIndex - 1]))
            },
        ...
        (function (e) {
            ...
            var s = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
                ...
                a = t.exports = {
                    ...
                    isNode: function () {
                        try {
                            return "object" === ("undefined" == typeof e ? "undefined" : s(e)) && "[object process]" === Object.prototype.toString.call(e)
                        } catch (t) {}
                        return !1
                    },
